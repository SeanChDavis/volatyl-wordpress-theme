...
function volatyl_palette_colors(): array {
	...
	return array(
		...
		array( 'name' => __( 'Action Lighter',                     'volatyl' ), 'slug' => 'action-lighter',       'color' => $vivid( 88, $action_hue ) ),
		...
		array( 'name' => __( 'Accent 1 Lighter',                   'volatyl' ), 'slug' => 'accent-1-lighter',     'color' => $vivid( 88, $accent_1_hue ) ),
		...
		array( 'name' => __( 'Accent 2 Lighter',                   'volatyl' ), 'slug' => 'accent-2-lighter',     'color' => $vivid( 88, $accent_2_hue ) ),
		...
		array( 'name' => __( 'Accent 3 Lighter',                   'volatyl' ), 'slug' => 'accent-3-lighter',     'color' => $vivid( 88, $accent_3_hue ) ),
