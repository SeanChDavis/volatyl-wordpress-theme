<?php
/**
 * Title: Split Section — Image Left
 * Slug: volatyl/split-image-left
 * Categories: featured, text
 * Post Types: page, post
 * Viewport Width: 1400
 * Description: Two-column section with an image on the left and text content on the right. Columns are vertically centered.
 */
?>
