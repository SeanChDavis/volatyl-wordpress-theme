...
$volatyl_footer_lead_cta_button_new_tab = get_theme_mod( 'volatyl_footer_lead_cta_button_new_tab', 0 );
		...
		<div class="footer-lead-cta">
			...
			<?php if ( $volatyl_footer_lead_cta_button_url && $volatyl_footer_lead_cta_button_text ) { ?>
				<div class="cta-action">
					<a href="<?php echo esc_url( $volatyl_footer_lead_cta_button_url ); ?>" class="v-button v-large"<?php if ( $volatyl_footer_lead_cta_button_new_tab ) { echo ' target="_blank" rel="noopener noreferrer"'; } ?>><?php echo esc_html( $volatyl_footer_lead_cta_button_text ); ?></a>
				</div>
			<?php } ?>
		</div>
	</div>
